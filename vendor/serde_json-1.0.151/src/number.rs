...
impl<'de> de::Deserialize<'de> for NumberKey {
        ...
        D: de::Deserializer<'de>,
    {
        ...
        impl<'de> de::Visitor<'de> for FieldVisitor {
            ...
            fn visit_bytes<E>(self, s: &[u8]) -> Result<(), E>
            where
                E: de::Error,
            {
                if s == TOKEN.as_bytes() {
...
impl<'de> Deserializer<'de> for NumberFieldDeserializer {
    ...
    where
        V: de::Visitor<'de>,
    {
        // JSON object keys are strings. Keep this synthetic marker on a
        // separate Serde data-model channel, including through enum buffering.
        visitor.visit_borrowed_bytes(TOKEN.as_bytes())
    }
