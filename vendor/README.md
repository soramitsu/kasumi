...
advisory, and the release gate must verify the exact patched sources. Registry
cache markers and VCS files are omitted. Original licenses and notices remain.
...
The release workflow must run both upstream suites in addition to the workspace
