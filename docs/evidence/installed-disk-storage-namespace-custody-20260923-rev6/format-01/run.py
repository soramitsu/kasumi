...
assert sha(pkg/'manifest.json')=='b2d6f9f980a55d0e1a688093cf2deb64269878005ff78e15f394af8341b336e5'
assert json.loads((native/'result.json').read_text())['all_passed']
