...
root=Path('/Users/mtakemiya/dev/kasumi');pkg=Path(__file__).resolve().parent.parent;expected_manifest='09b411af5662c5e14a7a93b1ab2dd476ef2e4925c3f42cbbd21f95a3019828c7';out=pkg/'native-01';assembly=pkg/'assembly';target=out/'cargo-target'
