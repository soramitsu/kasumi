...
root=Path('/Users/mtakemiya/dev/kasumi');pkg=Path(__file__).resolve().parent.parent;expected_manifest='64a8b440408c734c05b442aafbb9fa969862d78662178b8029a287dd66578b2e';out=pkg/'native-01';assembly=pkg/'assembly';target=out/'cargo-target'
...
focus_plan=json.loads((pkg/'focused-test-plan.json').read_text());assert len(focus_plan['focused_names'])==12;assert set(focus_plan['focused_names'])<=expected
