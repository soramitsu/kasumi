...
root=Path('/Users/mtakemiya/dev/kasumi');pkg=root/'target/installed-disk-validation/filesystem-backup-admission-revision5';out=pkg/'native-02';format_out=pkg/'format-01';assembly=out/'assembly'
...
def inventory_with_format():
 result=inventory()
 for p in [Path(__file__),toolchain/'rustfmt',toolchain/'cargo-fmt']:
