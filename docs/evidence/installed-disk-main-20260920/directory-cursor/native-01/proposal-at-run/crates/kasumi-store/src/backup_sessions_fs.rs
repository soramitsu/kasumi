...
impl Directory {
    ...
    pub fn list(
        ...
        // This read path must use an already-enrolled directory. Raw mkdir in
        // child() remains a separate, unqualified mutation adoption blocker.
        ...
        // Drop the actual DIR and counted directory before returning the page;
        // cancellation/error paths do the same through owned stack unwinding.
        drop(entries);
        proof.check()?;
