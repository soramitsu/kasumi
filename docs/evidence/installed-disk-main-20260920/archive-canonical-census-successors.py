...
Runs142–147 are included only with pinned terminal/drained receipts.
"""
...
INPUTS = SOURCE / 'archive-canonical-census-successors/inputs.json'
INPUT_SHA = 'c0076b211524f23736e37e512e40c86708e0163171af7abb61d320711b3dc6ea'
...
def main():
    ...
    require(len(old) >= 3345, 'Original3345-entry archive missing')
    if len(old) == 3345:
        require(hashlib.sha256(old_bytes).hexdigest() == '6878c076c688dcb6db6e2ede0fef5fc7c3b257944e20eb3b32bbbf532c1d95c4', 'Original3345 manifest differs')
    verify_archive(old)
    ...
    omission_name = f'canonical-census-native-binary-omissions/{omission_id}.json'
    ...
    receipt_name = f'canonical-census-append-receipts/{batch_id}.json'
