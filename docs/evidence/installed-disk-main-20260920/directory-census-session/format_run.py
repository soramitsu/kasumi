...
r=Path.cwd();p=r/'target/installed-disk-validation/directory-census-session';o=p/'format-01';o.mkdir();fmt=Path('/Users/mtakemiya/.rustup/toolchains/1.97.1-aarch64-apple-darwin/bin/rustfmt')
