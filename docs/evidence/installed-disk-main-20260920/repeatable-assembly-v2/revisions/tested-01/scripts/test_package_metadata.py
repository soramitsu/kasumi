...
class MetadataCustodyTests(unittest.TestCase):
    ...
    def capture(self, name="metadata"):
        ...
        result = package.capture_metadata(self.source, destination, self.target, self.inputs, {"tools": {"cargo": {"path": str(self.executable)}, "rustc": {"path": str(self.executable)}}, "cargo_home": str(self.tools)})
