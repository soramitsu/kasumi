...
class AssemblyCustodyTests(unittest.TestCase):
    ...
    def test_documented_frozen_dispatch_binds_imports_and_rejects_checkout_dispatch(self):
        ...
        self.assertIn("python3 -B -S /absolute/evidence/final-functional/source/scripts/repeatable_assembly.py", documented)
        self.assertNotIn("python3 -B -S scripts/repeatable_assembly.py", documented)
        ...
        for directory in (checkout, frozen):
            ...
            for name in ("repeatable_assembly.py", "assembly_inputs.py", "package_release.py", "release_gate.py", "gate_process.py", "verify_release_acceptance.py"):
            ...
            (scripts / "probe.py").write_text(
                "from pathlib import Path\nimport sys\nimport repeatable_assembly, assembly_inputs\n"
