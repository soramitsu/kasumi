"""Append immutable storage composition and file-custody prerequisite evidence; never replace history.
...
INPUTS = SOURCE / 'storage-composition-archive/inputs.json'
INPUT_SHA = '7524e051f112c239c9b17c03e5d535ef8eeecedc33469697f79734fe2ad7f8cd'
...
def main():
    ...
    require(len(old) >= 6389, 'Original6389-entry archive missing')
    if len(old) == 6389:
        require(hashlib.sha256(old_bytes).hexdigest() == '0474a63b10ff4129af22e13a5d61e77008373cc419bd6dabd7f3656f30c5e529', 'Original6389 manifest differs')
    verify_archive(old)
    ...
    omission_name = f'storage-composition-native-binary-omissions/{omission_id}.json'
    ...
    receipt_name = f'storage-composition-append-receipts/{batch_id}.json'
