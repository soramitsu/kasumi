...
common=[str(compiler),'--edition=2024','--crate-name','census_original_contract_diagnostic','-L','dependency='+str(deps),*extern,str(p/'driver.rs')]
commands=[('compiler',[str(compiler),'-vV']),('compile',common+['--cfg','feature="test-utils"','-o',str(p/'diagnostic')]),('run',[str(p/'diagnostic')])];results=[]
