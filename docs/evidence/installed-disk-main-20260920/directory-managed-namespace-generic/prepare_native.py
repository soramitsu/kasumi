...
r=Path.cwd();pkg=r/'target/installed-disk-validation/directory-managed-namespace-generic';prior=r/'target/installed-disk-validation/directory-managed-namespace/native-03'
