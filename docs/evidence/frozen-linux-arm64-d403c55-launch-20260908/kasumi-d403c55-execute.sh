...
python3 /workspace/scripts/release_gate.py --repository /workspace --output /evidence/run --jobs 2 --execution-description 'Native Linux ARM64 VZ reference VM; Debian 13 host, 2 vCPU, 8 GiB provisioned RAM, 200 GiB disk; pinned Rust1.97.1 Bookworm build image abf802c3daf7460f7498869910288b63bf5e138efc28e3c0704bf931b99e1ed4; container CPU2/memory7GiB. Host/image/package records retained. Functional integration checkpoint, not final capacity or endurance acceptance.'
