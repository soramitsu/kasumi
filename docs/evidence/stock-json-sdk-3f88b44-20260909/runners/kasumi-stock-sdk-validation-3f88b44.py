...
OUTPUT = Path('/tmp/kasumi-stock-sdk-validation-3f88b44')
...
gates = [
    ...
    ('canonical-admission-ordered', test_base + ['-p', 'kasumi-client', '--lib'] + ordered + [private, '--', '--exact', '--test-threads=1'], 'ordered', 1),
