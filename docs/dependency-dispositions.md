...
| RUSTSEC-2025-0134, rustls-pemfile unmaintained | Direct transport use is being replaced with rustls-pki-types PEM APIs. Final graph verification remains pending integration. |
