...
directory = root / 'benchmarks/results/release-matrix-macos-arm64-20260905-06'
...
validation = ['../macos-validation-20260905-embedded-audit/evidence.json',
              '../linux-validation-20260905-embedded-audit/evidence.json']
...
minio_evidence = '../linux-validation-20260905-embedded-audit/minio-evidence.json'
...
release_evidence = '../macos-validation-20260905-embedded-audit/release-build.json'
