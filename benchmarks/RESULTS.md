...
| Deployment | Tenants | Configured resident data voters | Control groups | Service audit stores | Qualified observation |
| --- | --- | --- | --- | --- | --- |
| raw | 1 | 0 | 0 | 0 | yes |
| local | 1 | 1 | 0 | 1 | yes |
